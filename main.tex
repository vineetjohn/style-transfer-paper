...
\begin{table*}[!t]
	...
	\resizebox{\textwidth}{!}{
		\begin{tabular}{|l||c|c|c|c|c||c|c|c|c|c| }
			...
			\cline{2-11}
			                                                 & \textbf{Transfer}                           & \textbf{Cosine}                              & \textbf{Word}    & \textbf{Geo-} & \multirow{2}{*}{\textbf{Fluency}} & \textbf{Transfer} & \textbf{Cosine}         & \textbf{Word}    & \textbf{Geo-} & \multirow{2}{*}{\textbf{Fluency}} \\
			                                                 & \textbf{Acc.}                               & \textbf{Sim.}                                & \textbf{Overlap} & \textbf{Mean} &                                   & \textbf{Acc.}     & \textbf{Sim.}           & \textbf{Overlap} & \textbf{Mean} &                                   \\
			\hline\hline
			Style-Embedding \cite{fu2018style}               & 0.182                                       & \textbf{0.959}                               & \textbf{0.666}   & 0.348         & -16.17                            & \ 0.400$^\dag$    & \ \textit{0.930}$^\dag$ & \textit{0.359}   & 0.387         & -28.13                            \\
			\hline
			Cross-Alignment \cite{shen2017style}             & \ 0.784$^\dag$                              & 0.892                                        & 0.209            & 0.411         & -23.39                            & 0.606             & 0.893                   & 0.024            & 0.121         & -26.31                            \\
			\hline
			Multi-Decoder \cite{zhao2018adversarially}       & \ 0.818$^\dag$                              & 0.883                                        & 0.272            & 0.476         & -20.95                            & 0.552             & 0.926                   & 0.169            & 0.306         & -34.70                            \\
			\hline
			DeleteRetrieveGenerate \cite{li2018delete}       & \ 0.508$^\ddag$                             & \ 0.921$^\ddag$                              & \ 0.469$^\ddag$  & 0.482         & \ -18.56$^\ddag$                  & 0.426             & \textbf{0.980}          & \textbf{0.799}   & 0.583         & \textit{-23.31}                   \\
			\hline
			BackTranslate \cite{prabhumoye2018style}\!\!\!\! & 0.854                                       & 0.831                                        & 0.075            & 0.254         & -20.85                            & \textbf{0.832}    & 0.821                   & 0.020            & 0.130         & -25.96                            \\
			\hline
			Cycle RL \cite{xu2018unpaired}                   & \ 0.805$^\ddag$                             & \ \textit{0.922}$^\ddag$                     & \ 0.427$^\ddag$  & 0.586         & \ -30.15$^\ddag$                  & \ 0.719$^\ddag$   & \ 0.912$^\ddag$         & \ 0.221$^\ddag$  & 0.398         & \ -22.97$^\ddag$                  \\
			\hline\hline
			Ours (DAE)                                       & {0.883}                                     & 0.915                                        & \textit{0.549}   & 0.696         & \textit{-10.17}                   & 0.720             & 0.921                   & 0.354            & 0.505         & -24.74                            \\
			\hline
			Ours (VAE)                                       & \textbf{0.934}                              & 0.904                                        & 0.473            & 0.665         & \textbf{-9.84}                    & {0.822}           & 0.900                   & 0.196            & 0.402         & \textbf{-21.70}                   \\
			\hline
