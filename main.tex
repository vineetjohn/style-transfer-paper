...
We use the Yelp review dataset \cite{challenge2013yelp} following previous work \cite{shen2017style,zhao2018adversarially}.
...
We also used the Amazon review dataset,\footnote{\url{http://jmcauley.ucsd.edu/data/amazon/}} following previous work \cite{fu2018style}.
