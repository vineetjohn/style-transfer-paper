...
\end{align}
where $\hyp{kl}$ is the hyperparameter, balancing the reconstruction loss and the KL terms. $p(\bm c)$ and $p(\bm s)$ are the priors, usually set to the standard normal distribution $\mathcal{N}(\bm 0,\mathrm I)$.
