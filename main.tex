...
Despite the above automatic metrics, we also have human evaluation to further confirm the performance of our model.
This was conducted on the Yelp dataset only, due to the large amount of human effort involved.
...
This evaluation was conducted in a strictly blind fashion: samples obtained by all competing models are randomly shuffled, so that the evaluator could not know which model generated a particular sentence.
