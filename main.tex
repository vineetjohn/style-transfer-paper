...
\begin{table*}[ht]
	...
	\begin{tabular}{| l || c | c | c | c |}
		...
		\hline\hline
		$\loss{VAE}$                                                                     & 0.11            & \textbf{0.94}     & 0.47           & -12.58          \\ \hline
		$\loss{VAE}$, $\loss{mul(s)}$                                                    & 0.77            & 0.91              & 0.33           & -12.17          \\ \hline
		$\loss{VAE}$, $\loss{mul(c)}$                                                    & 0.16            & 0.93              & 0.63           & -11.21          \\ \hline
		$\loss{VAE}$, $\loss{adv(s)}$                                                    & 0.78            & 0.89              & 0.23           & -12.03          \\ \hline
		$\loss{VAE}$, $\loss{adv(c)}$                                                    & 0.10            & 0.94              & 0.47           & -12.92          \\ \hline
		$\loss{VAE}$, $\loss{mul(s)}$, $\loss{mul(c)}$                                   & 0.82            & 0.93              & 0.56           & -11.32          \\ \hline
		$\loss{VAE}$, $\loss{mul(s)}$, $\loss{adv(s)}$                                   & 0.91            & 0.87              & 0.17           & \textbf{-9.59}  \\ \hline
		$\loss{VAE}$, $\loss{mul(s)}$, $\loss{adv(c)}$                                   & 0.78            & 0.91              & 0.32           & -11.99          \\ \hline
		$\loss{VAE}$, $\loss{mul(c)}$, $\loss{adv(s)}$                                   & 0.82            & 0.89              & 0.51           & -10.94          \\ \hline
		$\loss{VAE}$, $\loss{mul(c)}$, $\loss{adv(c)}$                                   & 0.15            & 0.93              & 0.62           & -11.22          \\ \hline
		$\loss{VAE}$, $\loss{adv(s)}$, $\loss{adv(c)}$                                   & 0.78            & 0.88              & 0.21           & -12.03          \\ \hline
		$\loss{VAE}$, $\loss{mul(s)}$, $\loss{mul(c)}$, $\loss{adv(s)}$                  & 0.92            & 0.90              & 0.48           & -9.65           \\ \hline
		$\loss{VAE}$, $\loss{mul(s)}$, $\loss{mul(c)}$, $\loss{adv(c)}$                  & 0.84            & 0.92              & 0.56           & -11.13          \\ \hline
		$\loss{VAE}$, $\loss{mul(s)}$, $\loss{adv(s)}$, $\loss{adv(c)}$                  & 0.93            & 0.86              & 0.16           & -10.11          \\ \hline
		$\loss{VAE}$, $\loss{mul(c)}$, $\loss{adv(s)}$, $\loss{adv(c)}$                  & 0.81            & 0.90              & 0.50           & -9.98           \\ \hline
		$\loss{VAE}$, $\loss{mul(s)}$, $\loss{adv(s)}$, $\loss{mul(c)}$, $\loss{adv(c)}$ & \textbf{0.93}   & 0.90              & \textbf{0.47}  & -9.84           \\ \hline
	\end{tabular}\vspace{-.2cm}
