...
Table~\ref{tab:manual-evaluation} present the results of human evaluation. Again, we see that the style embedding model \cite{fu2018style} is ineffective with a very low transfer strength, and that our methods outperform other baselines in terms of all aspects. The results are consistent with the automatic metrics in both experiments (Table~\ref{tab})
