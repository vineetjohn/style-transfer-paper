...
\begin{table*}[ht]
	...
	\begin{tabular}{| l || c | c | c | c | c |}
		...
		\hline\hline
		$\loss{AE}$                                                                     & 0.11            & \textbf{0.94}     & 0.47           & -           & -          \\ \hline
		$\loss{AE}$, $\loss{mul(s)}$                                                    & 0.77            & 0.91              & 0.33           & -           & -          \\ \hline
		% $\loss{AE}$, $\loss{mul(c)}$                                                    & 0.16            & 0.93              & 0.63           & -           & -          \\ \hline
		$\loss{AE}$, $\loss{adv(s)}$                                                    & 0.78            & 0.89              & 0.23           & -           & -          \\ \hline
		% $\loss{AE}$, $\loss{adv(c)}$                                                    & 0.10            & 0.94              & 0.47           & -           & -          \\ \hline
		% $\loss{AE}$, $\loss{mul(s)}$, $\loss{mul(c)}$                                   & 0.82            & 0.93              & 0.56           & -           & -          \\ \hline
		$\loss{AE}$, $\loss{mul(s)}$, $\loss{adv(s)}$                                   & 0.91            & 0.87              & 0.17           & -           & -          \\ \hline
		...
		$\loss{AE}$, $\loss{mul(s)}$, $\loss{adv(s)}$, $\loss{mul(c)}$, $\loss{adv(c)}$ & \textbf{0.93}   & 0.90              & \textbf{0.47}  & -           & -          \\ \hline
	\end{tabular}\vspace{-.2cm}
