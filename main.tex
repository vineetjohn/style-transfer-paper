...
The autoencoding loss (\ref{eqn:ae}) serves as our primary training objective.
Besides, an autoencoder is also used for text generation in the style-transfer application.
