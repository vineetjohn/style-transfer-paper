...
\begin{table}[!t]
	...
	\resizebox{\linewidth}{!}{
		\begin{tabular}{|l||c|c|c||c|}
			\hline
			\tabc{2}{Model}               & \tabh{Transfer} & \tabh{Content}      & \tabh{Language} &\tabh{Geo-}\\
			                              & \tabh{Strength} & \tabh{Preservation} & \tabh{Quality} &\tabh{Mean} \\
			\hline
			\hline		\citet{fu2018style}     & 1.67            & \textbf{3.84}       & 3.66       \\    \hline
			\citet{shen2017style}         & 3.63            & 3.07                & 3.08            \\
			\hline
			\citet{zhao2018adversarially} & 3.55            & 3.09                & 3.77            \\
			\hline
