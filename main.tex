...
\begin{table*}[!t]
	...
	\resizebox{\textwidth}{!}{
		\begin{tabular}{|l||c|c|c|c|c||c|c|c|c|c| }
			...
			\hline\hline
			Style-Embedding \cite{fu2018style}               & 0.182                                       & \textbf{0.959}                               & \textbf{0.666}   & xxx           & -16.17                            & \ 0.400$^\dag$    & \ \textit{0.930}$^\dag$ & \textit{0.359}   & xxx           & -28.13                            \\
			\hline
			Cross-Alignment \cite{shen2017style}             & \ 0.784$^\dag$                              & 0.892                                        & 0.209            & xxx           & -23.39                            & 0.606             & 0.893                   & 0.024            & xxx           & -26.31                            \\
			\hline
			Multi-Decoder \cite{zhao2018adversarially}       & \ 0.818$^\dag$                              & 0.883                                        & 0.272            & xxx           & -20.95                            & 0.552             & 0.926                   & 0.169            & xxx           & -34.70                            \\
			\hline
			DeleteRetrieveGenerate \cite{li2018delete}       & \ 0.508$^\ddag$                             & \ 0.921$^\ddag$                              & \ 0.469$^\ddag$  & xxx           & \ -18.56$^\ddag$                  & 0.426             & \textbf{0.980}          & \textbf{0.799}   & xxx           & \textit{-23.31}                   \\
			\hline
			BackTranslate \cite{prabhumoye2018style}\!\!\!\! & 0.854                                       & 0.831                                        & 0.075            & xxx           & -20.85                            & \textbf{0.832}    & 0.821                   & 0.020            & xxx           & -25.96                            \\
			\hline
			Cycle RL \cite{xu2018unpaired}                   & \ 0.805$^\ddag$                             & \ \textit{0.922}$^\ddag$                     & \ 0.427$^\ddag$  & xxx           & \ -30.15$^\ddag$                  & \ 0.719$^\ddag$   & \ 0.912$^\ddag$         & \ 0.221$^\ddag$  & xxx           & \ -22.97$^\ddag$                  \\
			\hline\hline
			Ours (DAE)                                       & {0.883}                                     & 0.915                                        & \textit{0.549}   & xxx           & \textit{-10.17}                   & 0.720             & 0.921                   & 0.354            & xxx           & -24.74                            \\
			\hline
			Ours (VAE)                                       & \textbf{0.934}                              & 0.904                                        & 0.473            & xxx           & \textbf{-9.84}                    & {0.822}           & 0.900                   & 0.196            & xxx           & \textbf{-21.70}                   \\
			\hline
