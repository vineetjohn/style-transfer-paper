...
\begin{table}[!t]
	...
	\resizebox{\linewidth}{!}{
		\begin{tabular}{|l||r|r||r|r|}
			...
			\hline
			None (majority guess)                  & \multicolumn{2}{c||}{0.60}          & \multicolumn{2}{c|}{0.51}                                        \\
			\hline
			Content space  ($\bm c$)               & 0.66                                & 0.70                                 & 0.67         & 0.69       \\ \hline
			Style space ($\bm s$)                  & 0.97                                & 0.97                                 & 0.82         & 0.81       \\ \hline
			Complete space ($[\bm s;\bm c]$)       & 0.97                                & 0.97                                 & 0.82         & 0.81       \\
			\hline
		\end{tabular}}
...
\begin{table*}[!t]
	...
	\resizebox{\textwidth}{!}{
		\begin{tabular}{|l||c|c|c|c|c||c|c|c|c|c| }
			\hline
			\tabc{3}{Model}                                     & \multicolumn{5}{c||}{\textbf{Yelp Dataset}} & \multicolumn{5}{c|}{\textbf{Amazon Dataset}}                                                                                                                                                                             \\
			\cline{2-11}
			                                                    & \textbf{Transfer}                           & \textbf{Cosine}                              & \textbf{Word}    & \textbf{Geo-} & \multirow{2}{*}{\textbf{PPL}} & \textbf{Transfer} & \textbf{Cosine} & \textbf{Word}    & \textbf{Geo-} & \multirow{2}{*}{\textbf{PPL}} \\
			                                                    & \textbf{Acc.}                               & \textbf{Sim.}                                & \textbf{Overlap} & \textbf{Mean} &                               & \textbf{Acc.}     & \textbf{Sim.}   & \textbf{Overlap} & \textbf{Mean} &                               \\
			\hline\hline
			Style-Embedding \cite{fu2018style}                  & 0.18                                        & \textbf{0.96}                                & \textbf{0.67}    & 0.35          & 124                           & \ 0.40$^\dag$     & \ 0.93$^\dag$   & 0.36             & 0.39          & \textbf{32}                   \\
			\hline
			Cross-Alignment \cite{shen2017style}                & \ 0.78$^\dag$                               & 0.89                                         & 0.21             & 0.41          & 93                            & 0.61              & 0.89            & 0.02             & 0.12          & 202                           \\
			\hline
			Multi-Decoder \cite{zhao2018adversarially}          & \ 0.82$^\dag$                               & 0.88                                         & 0.27             & 0.48          & 85                            & 0.55              & 0.93            & 0.17             & 0.31          & 75                            \\
			\hline
			DeleteRetrieveGenerate \cite{li2018delete} $^\ddag$ & 0.86                                        & 0.94                                         & 0.52             & 0.67          & 70                            & 0.43              & \textbf{0.98}   & \textbf{0.80}    & \textbf{0.58} & 65                            \\
			\hline
			BackTranslate \cite{prabhumoye2018style}            & 0.85                                        & 0.83                                         & 0.08             & 0.25          & 206                           & \textbf{0.83}     & 0.82            & 0.02             & 0.13          & 115                           \\
			\hline
			Cycle RL \cite{xu2018unpaired} $^\ddag$             & 0.80                                        & 0.92                                         & 0.43             & 0.59          & 470                           & 0.72              & 0.91            & 0.22             & 0.40          & 332                           \\
			\hline\hline
			Ours (DAE)                                          & 0.88                                        & 0.92                                         & 0.55             & \textbf{0.70} & 137                           & 0.72              & 0.92            & 0.35             & 0.50          & 73                            \\
			\hline
			Ours (VAE)                                          & \textbf{0.93}                               & 0.90                                         & 0.47             & 0.66          & \textbf{69}                   & 0.82              & 0.90            & 0.20             & 0.40          & 63                            \\
			\hline
...
\begin{table}[!t]
	...
	\resizebox{\linewidth}{!}{
		\begin{tabular}{|l||c|c|c||c|}
			\hline
			\tabc{2}{Model}               & \tabh{Transfer} & \tabh{Content}      & \tabhr{Language} & \tabh{Geo-}   \\
			                              & \tabh{Strength} & \tabh{Preservation} & \tabhr{Quality}  & \tabh{Mean}   \\
			\hline
			\hline
			\citet{fu2018style}           & 1.67            & \textbf{3.84}       & 3.66             & 2.86          \\
			\hline
			\citet{shen2017style}         & 3.63            & 3.07                & 3.08             & 3.25          \\
			\hline
			\citet{zhao2018adversarially} & 3.55            & 3.09                & 3.77             & 3.46          \\
			\hline\hline
			Ours (DAE)                    & 3.67            & 3.64                & 4.19             & 3.83          \\
			\hline
			Ours (VAE)                    & \textbf{4.32}   & 3.73                & \textbf{4.48}    & \textbf{4.16} \\
			\hline
		\end{tabular}}
...
\begin{table*}[ht]
	...
	\begin{tabular}{| l || c | c | c | c |}
		...
		\hline
		\hline
		$\loss{AE}$                                                                      & 0.11            & \textbf{0.94}     & 0.47           & -12.58          \\
		\hline
		$\loss{AE}$, $\loss{mul(s)}$                                                     & 0.77            & 0.91              & 0.33           & -12.17          \\
		% \hline
		% $\loss{AE}$, $\loss{mul(c)}$                                                     & 0.16            & 0.93              & 0.63           & -11.21          \\
		\hline
		$\loss{VAE}$, $\loss{adv(s)}$                                                    & 0.78            & 0.89              & 0.23           & -12.03          \\
		% \hline
		% $\loss{AE}$, $\loss{adv(c)}$                                                     & 0.10            & 0.94              & 0.47           & -12.92          \\
		% \hline
		% $\loss{AE}$, $\loss{mul(s)}$, $\loss{mul(c)}$                                    & 0.82            & 0.93              & 0.56           & -11.32          \\
		\hline
		$\loss{VAE}$, $\loss{mul(s)}$, $\loss{adv(s)}$                                   & 0.91            & 0.87              & 0.17           & \textbf{-9.59}  \\
		% \hline
		% $\loss{AE}$, $\loss{mul(s)}$, $\loss{adv(c)}$                                    & 0.78            & 0.91              & 0.32           & -11.99          \\
		% \hline
		% $\loss{AE}$, $\loss{mul(c)}$, $\loss{adv(s)}$                                    & 0.82            & 0.89              & 0.51           & -10.94          \\
		% \hline
		% $\loss{AE}$, $\loss{mul(c)}$, $\loss{adv(c)}$                                    & 0.15            & 0.93              & 0.62           & -11.22          \\
		% \hline
		% $\loss{AE}$, $\loss{adv(s)}$, $\loss{adv(c)}$                                    & 0.78            & 0.88              & 0.21           & -12.03          \\
		% \hline
		% $\loss{AE}$, $\loss{mul(s)}$, $\loss{mul(c)}$, $\loss{adv(s)}$                   & 0.92            & 0.90              & 0.48           & -9.65           \\
		% \hline
		% $\loss{AE}$, $\loss{mul(s)}$, $\loss{mul(c)}$, $\loss{adv(c)}$                   & 0.84            & 0.92              & 0.56           & -11.13          \\
		% \hline
		% $\loss{AE}$, $\loss{mul(s)}$, $\loss{adv(s)}$, $\loss{adv(c)}$                   & 0.93            & 0.86              & 0.16           & -10.11          \\
		% \hline
		% $\loss{AE}$, $\loss{mul(c)}$, $\loss{adv(s)}$, $\loss{adv(c)}$                   & 0.81            & 0.90              & 0.50           & -9.98           \\
		\hline
		$\loss{VAE}$, $\loss{mul(s)}$, $\loss{adv(s)}$, $\loss{mul(c)}$, $\loss{adv(c)}$ & \textbf{0.93}   & 0.90              & \textbf{0.47}  & -9.84           \\
		\hline
	\end{tabular}\vspace{-.2cm}
