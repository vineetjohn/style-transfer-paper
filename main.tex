...
\begin{table*}[ht]
	...
	\begin{tabular}{| l || c | c | c | c |}
		...
		\hline
		$\loss{rec}$, $\loss{adv(s)}$, $\loss{mul(c)}$                                   &                 &                   &                &                 \\
		\hline
		$\loss{rec}$, $\loss{adv(s)}$, $\loss{adv(c)}$                                   &                 &                   &                &                 \\
		\hline
		$\loss{rec}$, $\loss{mul(c)}$, $\loss{adv(c)}$                                   &                 &                   &                &                 \\
		\hline
		$\loss{rec}$, $\loss{mul(s)}$, $\loss{adv(s)}$, $\loss{mul(c)}$                  &                 &                   &                &                 \\
		\hline
		$\loss{rec}$, $\loss{mul(s)}$, $\loss{adv(s)}$, $\loss{adv(c)}$                  &                 &                   &                &                 \\
		\hline
		$\loss{rec}$, $\loss{mul(s)}$, $\loss{mul(c)}$, $\loss{adv(c)}$                  &                 &                   &                &                 \\
		\hline
		$\loss{rec}$, $\loss{adv(s)}$, $\loss{mul(c)}$, $\loss{adv(c)}$                  &                 &                   &                &                 \\
		\hline
		$\loss{rec}$, $\loss{mul(s)}$, $\loss{adv(s)}$, $\loss{mul(c)}$, $\loss{adv(c)}$ &                 &                   &                &                 \\
		\hline
	\end{tabular}
