...
\begin{table*}[!t]
	...
	\resizebox{\textwidth}{!}{
		\begin{tabular}{|l||c|c|c|c||c|c|c|c| }
			...
			\hline
			\hline
			Style-Embedding \cite{fu2018style}                   & 0.182                                       & \textbf{0.959}                               & \textbf{0.666}   & -16.17            & \ 0.400$^\dag$    & \ \textit{0.930}$^\dag$ & \textit{0.359}   & -28.13            \\
			\hline		\hline
			Cross-Alignment \cite{shen2017style}                 & \ 0.784$^\dag$                              & 0.892                                        & 0.209            & -23.39            & 0.606             & 0.893                   & 0.024            & -26.31            \\
			\hline
			Multi-Decoder \cite{zhao2018adversarially}           & \ 0.818$^\dag$                              & 0.883                                        & 0.272            & -20.95            & 0.552             & 0.926                   & 0.169            & -34.70            \\
			\hline
			Delete Retrieve Generate \cite{li2018delete}         & 0.508                                       & 0.921                                        & 0.469            & -18.56            & 0.426             & \textbf{0.980}          & \textbf{0.799}   & \textit{-23.31}   \\
			\hline
			Back Translation \cite{prabhumoye2018style}          & 0.854                                       & 0.831                                        & 0.075            & -20.85            & \textbf{0.832}    & 0.821                   & 0.020            & -25.96            \\
			\hline
			Unpaired Sentiment Translation \cite{xu2018unpaired} & 0.805                                       & \textit{0.922}                               & 0.427            & -30.15            & 0.719             & 0.912                   & 0.221            & -32.89            \\
			\hline
			Ours (DAE)                                           & \textit{0.883}                              & 0.915                                        & \textit{0.549}   & \textit{-10.17}   & 0.720             & 0.921                   & 0.354            & -24.74            \\
			\hline
			Ours (VAE)                                           & \textbf{0.934}                              & 0.904                                        & 0.473            & \textbf{-9.84}    & \textit{0.822}    & 0.900                   & 0.196            & \textbf{-21.70}   \\
			\hline
...
\begin{table}[!t]
	...
	\resizebox{\linewidth}{!}{
		\begin{tabular}{| l || c | c | c | }
			...
			\hline
			\hline		\citet{fu2018style}     & 1.67            & \textbf{3.84}       & 3.66            \\\hline\hline
